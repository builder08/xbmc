...
static const std::map<ActionName, ActionID> ActionMappings = {
    ...
    {"verticalshifttop", ACTION_VSHIFT_TOP},
    {"verticalshiftcenter", ACTION_VSHIFT_CENTER},
    {"verticalshiftbottom", ACTION_VSHIFT_BOTTOM},
    {"verticalshifttop239", ACTION_VSHIFT_TOP239},
    {"verticalshiftbottom239", ACTION_VSHIFT_BOTTOM239},
